...
output "ruby_3_4_arn" {
  description = "Amazon Resource Name (ARN) identifying your Lambda Function."
  value       = module.lambda-ruby-3-4.arn
}

output "ruby_3_4_invoke_arn" {
  description = "ARN to be used for invoking Lambda Function from API Gateway."
  value       = module.lambda-ruby-3-4.invoke_arn
}

output "ruby_3_4_function_name" {
  description = "Unique name for your Lambda Function"
  value       = module.lambda-ruby-3-4.function_name
}

output "ruby_3_3_arn" {
  description = "Amazon Resource Name (ARN) identifying your Lambda Function."
  value       = module.lambda-ruby-3-3.arn
}

output "ruby_3_3_invoke_arn" {
  description = "ARN to be used for invoking Lambda Function from API Gateway."
  value       = module.lambda-ruby-3-3.invoke_arn
}

output "ruby_3_3_function_name" {
  description = "Unique name for your Lambda Function"
  value       = module.lambda-ruby-3-3.function_name
}

output "ruby_3_2_arn" {
  description = "Amazon Resource Name (ARN) identifying your Lambda Function."
  value       = module.lambda-ruby-3-2.arn
}

output "ruby_3_2_invoke_arn" {
  description = "ARN to be used for invoking Lambda Function from API Gateway."
  value       = module.lambda-ruby-3-2.invoke_arn
}

output "ruby_3_2_function_name" {
  description = "Unique name for your Lambda Function"
  value       = module.lambda-ruby-3-2.function_name
}