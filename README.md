...
module "lambda-datadog" {
  ...
  datadog_python_layer_version = 105
}
```
...
| <a name="input_datadog_python_layer_version"></a> [datadog\_python\_layer\_version](#input\_datadog\_python\_layer\_version) | Version for the Datadog Python Layer | `number` | `105` | no |
