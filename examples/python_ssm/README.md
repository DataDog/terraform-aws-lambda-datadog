# Python Lambda Example with SSM Parameter Store

This example demonstrates deploying a Python Lambda function with Datadog monitoring using AWS Systems Manager (SSM) Parameter Store to store the Datadog API key.
